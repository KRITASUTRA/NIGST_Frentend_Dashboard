...
export default function CreationFacultyPosition() {
  ...
  function handleFacultyCreation() {
    ...
    const url = "http://ec2-65-1-131-144.ap-south-1.compute.amazonaws.com/sauth/position"
  ...
  function facultyPositionViewFun(){
    const url = "http://ec2-65-1-131-144.ap-south-1.compute.amazonaws.com/sauth/view";
